...
public class LoginController {
	...
	public ResponseEntity<String> loginFirstStep(@PathVariable String username, @PathVariable String password) throws InvalidLoginCredentialsException, UserNotFoundException{
		try {
			String response = loginService.loginUserFirstStep(username, password);
